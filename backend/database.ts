...
db.serialize(() => {
    ...
    // Seed shop items
    const initialItems = [
        { name: 'Sports Car', category: 'vehicle', price: 500, image_url: 'https://files.catbox.moe/qn5v4f.jpg', description: 'A sleek virtual sports car for your profile.', is_limited: 0 },
        { name: 'Motorcycle', category: 'vehicle', price: 350, image_url: 'https://files.catbox.moe/9tz4t5.jpg', description: 'A cool virtual bike for cruising.', is_limited: 0 },
        { name: 'Skateboard', category: 'vehicle', price: 200, image_url: 'https://files.catbox.moe/yi2kzs.jpg', description: 'Shred in style with this virtual board.', is_limited: 0 },
        { name: 'Hoverboard', category: 'vehicle', price: 300, image_url: 'https://files.catbox.moe/kyzzna.jpg', description: 'Glide into the future.', is_limited: 0 },
        { name: 'Jetpack', category: 'vehicle', price: 800, image_url: 'https://files.catbox.moe/8c7bqh.jpg', description: 'Soar above the rest.', is_limited: 0 },
        { name: 'Vintage Van', category: 'vehicle', price: 450, image_url: 'https://files.catbox.moe/4zliff.jpg', description: 'Retro vibes on wheels.', is_limited: 0 },
        { name: 'UFO', category: 'vehicle', price: 1000, image_url: 'https://files.catbox.moe/c55hlo.jpg', description: 'Out-of-this-world transport.', is_limited: 1, stock: 20 },
        { name: 'Bear', category: 'animal', price: 300, image_url: 'https://files.catbox.moe/kjkv4m.jpg', description: 'A cuddly virtual bear companion.', is_limited: 0 },
        { name: 'Lion', category: 'animal', price: 400, image_url: 'https://files.catbox.moe/5ln5xa.jpg', description: 'A majestic virtual lion to show your strength.', is_limited: 0 },
        { name: 'Wolf', category: 'animal', price: 350, image_url: 'https://files.catbox.moe/pg9p56.jpg', description: 'A fierce virtual wolf for your squad.', is_limited: 0 },
        { name: 'Panda', category: 'animal', price: 320, image_url: 'https://files.catbox.moe/ei72qs.jpg', description: 'An adorable virtual panda.', is_limited: 0 },
        { name: 'Eagle', category: 'animal', price: 380, image_url: 'https://files.catbox.moe/6d0kgj.jpg', description: 'A soaring virtual eagle.', is_limited: 0 },
        { name: 'Dragon', category: 'animal', price: 900, image_url: 'https://files.catbox.moe/y5adaj.jpg', description: 'A mythical virtual dragon.', is_limited: 1, stock: 15 },
        { name: 'Unicorn', category: 'animal', price: 600, image_url: 'https://files.catbox.moe/kfs0hv.jpg', description: 'A magical unicorn for your squad.', is_limited: 0 },
        { name: 'Sneakers', category: 'fashion', price: 250, image_url: 'https://files.catbox.moe/q9g32o.jpg', description: 'Fresh kicks for your avatar.', is_limited: 0 },
        { name: 'Hoodie', category: 'fashion', price: 280, image_url: 'https://files.catbox.moe/w6fqvo.jpg', description: 'Cozy virtual style.', is_limited: 0 },
        { name: 'Sunglasses', category: 'fashion', price: 200, image_url: 'https://files.catbox.moe/659623.jpg', description: 'Cool shades for your vibe.', is_limited: 0 },
        { name: 'Crown', category: 'fashion', price: 450, image_url: 'https://files.catbox.moe/xjnpb4.jpg', description: 'Rule the platform with this crown.', is_limited: 0 },
        { name: 'Cape', category: 'fashion', price: 400, image_url: 'https://files.catbox.moe/y216zq.jpg', description: 'A heroic virtual cape.', is_limited: 0 },
        { name: 'Glow-in-the-Dark Jacket', category: 'fashion', price: 550, image_url: 'https://files.catbox.moe/pvjb6z.jpg', description: 'Light up the night.', is_limited: 0 },
        { name: 'Headphones', category: 'accessory', price: 220, image_url: 'https://files.catbox.moe/99fdsi.jpg', description: 'Jam out in style.', is_limited: 0 },
        { name: 'Smartwatch', category: 'accessory', price: 260, image_url: 'https://files.catbox.moe/k5qtdo.jpg', description: 'Stay connected virtually.', is_limited: 0 },
        { name: 'Neon Sword', category: 'accessory', price: 350, image_url: 'https://files.catbox.moe/zvj6ni.jpg', description: 'A glowing blade for battles.', is_limited: 0 },
        { name: 'Magic Wand', category: 'accessory', price: 300, image_url: 'https://files.catbox.moe/7bqe2g.jpg', description: 'Cast virtual spells.', is_limited: 0 },
        { name: 'Holographic Shield', category: 'accessory', price: 420, image_url: 'https://files.catbox.moe/ihk4vt.jpg', description: 'Defend in style.', is_limited: 0 },
    ];
