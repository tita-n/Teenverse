                ...
                <div className="hidden md:flex items-center space-x-4">
                    {user ? (
                        <>
                            ...
                            <Link to="/shop" className="text-white hover:text-indigo-200">
                                Shop
                            </Link>
                            <Link to={`/profile/${user.username}`} className="text-white hover:text-indigo-200">
                                Profile
                            </Link>
                            {user.email === "restorationmichael3@gmail.com" && (
                                <Link to="/control-panel" className="text-white hover:text-indigo-200">
                                    Control Panel
                                </Link>
                            )}
                            <button
